...
const UpdateProfileOrganize = () => {
    ...
    const handleSubmit=(e)=>{
        ...
        const moreEmail=form.newEmail.value
        const story=form.story.value
       
        const Organizer={name,image,number,preference,story,moreEmail}
        console.log(Organizer)
        axiosSecure.patch(`/participant/${participant.email}`, Organizer)
        .then(res=>{
    ...
    return (
        <div>
        <Helmet>
        <title>Medical-Camp | Organizer Profile  Update </title>
        </Helmet>
        <div className="w-[1000px] ">
  <section className="bg-gray-50 dark:bg-gray-900">
    <div className="flex flex-col px-6 py-8 mx-auto md:h-screen  lg:py-0">
  
      <div className="w-[1000px]  rounded-lg  dark:border md:mt-0 sm:w-[340px] xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          ...
          <form onSubmit={handleSubmit}  className="w-[800px] text-2xl space-x-5 md:space-y-2" action="#">
            ...
            <div>
              ...
              <input
                ...
                name="story"
                id="story"
                defaultValue={participant.story}
            ...
            <div>
              ...
              <input
                type="text"
                name="newEmail"
                defaultValue={participant.newEmail}
                id="newEmail"
                className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
...
export default UpdateProfileOrganize;